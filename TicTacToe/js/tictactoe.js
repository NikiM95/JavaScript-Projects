...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //The next 3 varibales will be used to check for 3 in a row.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.strokeStyle = 'rgba(35, 2, 19, 0.8)';
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10;}
            //This condition cancels our animation loop if reached the end point.
